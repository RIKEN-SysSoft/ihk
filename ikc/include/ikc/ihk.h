...
#define ihk_ikc_get_intr_list_lock ihk_os_get_intr_list_lock
#define ihk_ikc_get_intr_list      ihk_os_get_intr_list
#endif
...
ihk_spinlock_t *ihk_ikc_get_intr_list_lock(ihk_os_t ihk_os, int cpu);
