...
struct ihk_os_rusage ru_input_before[5];
struct ihk_os_rusage ru_input_after[5];
struct ihk_os_rusage ru_expected[5];
 ...
 */
#if 1
	ru_expected[2].memory_stat_rss[IHK_OS_PGSIZE_4KB] = PAGE_SIZE * 1024;
#else
