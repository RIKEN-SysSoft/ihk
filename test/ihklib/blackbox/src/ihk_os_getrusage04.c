...
const char param[] = "address of rusage";
const char *values[] = {
	"NULL",
	"valid address",
};

struct ihk_os_rusage ru_before;
struct ihk_os_rusage ru_after;
 ...
 */
#if 1
	ru_expected[1].memory_stat_rss[IHK_OS_PGSIZE_4KB] = PAGE_SIZE * 1024;
#else
