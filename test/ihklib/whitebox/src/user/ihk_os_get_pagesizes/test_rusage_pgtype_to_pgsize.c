...
int main(int argc, char **argv)
{
  ...
  char mode[6] = "\0";
  sprintf(mode, "%d", TEST_RUSAGE_PGTYPE_TO_PGSIZE);
  ...
  long pagesizes_input[IHK_MAX_NUM_PGSIZES] = { 0 };
  ret = ihk_os_get_pagesizes(os_index,
    pagesizes_input, IHK_MAX_NUM_PGSIZES);
  INTERR(ret, "ihk_os_get_pagesizes returned %d\n", ret);
